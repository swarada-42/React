    ...
    <div className="container " style={myStyle}>
      ...
      <div className="accordion" id="accordionExample" style={myStyle}>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              Learn gives you a way to analyze your text quickly and efficiently.
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              Learn is a free character counter tool that provides instant character count & word count statistics for a given text. 
              Learn reports the number of words and characters. 
